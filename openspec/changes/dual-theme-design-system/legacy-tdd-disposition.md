...
This change was applied under **Standard** ("no strict TDD active for this project", per this change's own apply record) — before `strict_tdd` was enabled on **2026-09-12**, the date
